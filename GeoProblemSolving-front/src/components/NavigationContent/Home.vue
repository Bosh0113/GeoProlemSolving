<template>
  <div class="home">
    <div class="home-screen">
      ...
      <div class="content">
        <div>
          <span class="title">一站式地理问题解决平台</span>
          <span class="desc">助你解决地理相关问题</span>
        </div>
      </div>
    </div>
    <div class="main-container">
      ...
      <div class="tools">
        <h1 class="tools-title">探索更多功能</h1>
        <Row
        ...
        >
          ...
          <span class="card-desc">Blablalba,blalablabalbabla,balbalbalbal.</span>
        ...
        .mask {
          .bg {
            ...
            transition: background-color 0.6s 0s
              cubic-bezier(0.02, 0.67, 0.45, 0.93);
            &:hover {
