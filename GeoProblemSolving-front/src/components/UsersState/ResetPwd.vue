      ...
      >
        ...
        >
          ...
          <div style="display:flex;justify-content:center;margin-top:40px">
            <Button type="default" @click="resetPwd()" :disabled="formValidate.newPassword!=formValidate.confirmPassword||formValidate.newPassword==''||formValidate.confirmPassword==''">Assure</Button>
          </div>
        </Form>
      </div>
    </Col>
